...
class DataGenerationConfig(BaseModel):
    ...
    avg_transactions_per_month: int = Field(
        default=30, ge=10, le=100, description="Average transactions per user per month"
    )
    generation_timestamp: datetime = Field(
        default_factory=datetime.now, description="When data was generated"
    )
