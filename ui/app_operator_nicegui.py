...
def render_recommendation_review_tab():
    """Render Recommendation Management tab with table view for bulk operations."""
    import requests
    ...
    from ui.components.operator_recommendations_manager import OperatorRecommendationsManager

    manager = OperatorRecommendationsManager(api_base_url="http://localhost:8000")
    ...
    with ui.card().classes(ThemeManager.get_card_classes()):
        ...
        with ui.row().classes("w-full gap-4 mb-4"):
            user_filter = ui.select(
                ...
                options=["All Users"] + users_df["user_id"].tolist(),
                value="All Users"
            ).classes("w-64")
        ...
        manager.refresh_data = refresh_all
...
@ui.refreshable
def render_recommendation_review_tab_old():
